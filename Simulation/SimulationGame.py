...
def Filling_Field(kickoff, home_starting_team, away_starting_team):
    ...
    "GoalKeepers"
    kickoff.field[33][2] = kc.Player(home_starting_team[0], [33, 2], "GoalKeeper")
    HomeTeam.append(kickoff.field[33][2])
    
    kickoff.field[33][100 - 2] = kc.Player(away_starting_team[0], [33, 100 - 2], "GoalKeeper")
    AwayTeam.append(kickoff.field[33][100 - 2])

    "Defenders"
    kickoff.field[24][26] = kc.Player(home_starting_team[1][0], [24, 26], "Defender")
    HomeTeam.append(kickoff.field[24][26])
    
    kickoff.field[24][100 - 26] = kc.Player(away_starting_team[1][0], [24, 100 - 26], "Defender")
    AwayTeam.append(kickoff.field[24][100 - 26])
    
    kickoff.field[68 - 24][26] = kc.Player(home_starting_team[1][1], [68 - 24, 26], "Defender")
    HomeTeam.append(kickoff.field[68 - 24][26])
    
    kickoff.field[68 - 24][100 - 26] = kc.Player(away_starting_team[1][1], [68 - 24, 100 - 26], "Defender")
    AwayTeam.append(kickoff.field[68 - 24][100 - 26])
    
    kickoff.field[12][28] = kc.Player(home_starting_team[1][2], [12, 28], "Defender")
    HomeTeam.append(kickoff.field[12][28])
    
    kickoff.field[12][100 - 28] = kc.Player(away_starting_team[1][2], [12, 100 - 28], "Defender")
    AwayTeam.append(kickoff.field[12][100 - 28])
    
    kickoff.field[68 - 12][28] = kc.Player(home_starting_team[1][3], [68 - 12, 28], "Defender")
    HomeTeam.append(kickoff.field[68 - 12][28])
    
    kickoff.field[68 - 12][100 - 28] = kc.Player(away_starting_team[1][3], [68 - 12, 100 - 28], "Defender")
    AwayTeam.append(kickoff.field[68 - 12][100 - 28])
     
    "MidFields"
    kickoff.field[12][40] = kc.Player(home_starting_team[2][0], [12, 40], "MidField")
    HomeTeam.append(kickoff.field[12][40])
    
    kickoff.field[12][100 - 40] = kc.Player(away_starting_team[2][0], [12, 100 - 40], "MidField")
    AwayTeam.append(kickoff.field[12][100 - 40])
    
    kickoff.field[24][40] = kc.Player(home_starting_team[2][1], [24, 40], "MidField")
    HomeTeam.append(kickoff.field[24][40])
    
    kickoff.field[24][100 - 40] = kc.Player(away_starting_team[2][1], [24, 100 - 40], "MidField")
    AwayTeam.append(kickoff.field[24][100 - 40])
    
    kickoff.field[68 - 24][40] = kc.Player(home_starting_team[2][2], [68 - 24, 40], "MidField")
    HomeTeam.append(kickoff.field[68 - 24][40])
    
    kickoff.field[68 - 24][100 -40] = kc.Player(away_starting_team[2][2], [68 - 24, 100 - 40], "MidField")
    AwayTeam.append(kickoff.field[68 - 24][100 - 40])
    
    kickoff.field[68 - 12][40] = kc.Player(home_starting_team[2][3], [68 - 12, 40], "MidField")
    HomeTeam.append(kickoff.field[68 - 12][40])
    
    kickoff.field[68 - 12][100 - 40] = kc.Player(away_starting_team[2][3], [68 - 12, 100 - 40], "MidField")
    AwayTeam.append(kickoff.field[68 - 12][100 - 40])
    
    "Forwards"
    kickoff.field[24][48] = kc.Player(home_starting_team[3][0], [24, 48], "Forward")
    HomeTeam.append(kickoff.field[24][48])
    
    kickoff.field[24][100 - 48] = kc.Player(away_starting_team[3][0], [24, 100 - 48], "Forward")
    AwayTeam.append(kickoff.field[24][100 - 48])
    
    kickoff.field[68 - 24][48] = kc.Player(home_starting_team[3][1], [68 - 24, 48], "Forward")
    HomeTeam.append(kickoff.field[68 - 24][48])
    
    kickoff.field[68 - 24][100 - 48] = kc.Player(away_starting_team[3][1], [68 - 24, 100 - 48], "Forward")
...
Kick_off = kc.Game()
kc.field, Home_PlayingTeam, Away_PlayingTeam = Filling_Field(Kick_off, Home_Starting_Team, Away_Starting_Team)
field = kc.field
